...
<body>
 ...
 <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-lg-auto text-lg-right text-center">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="listaPedidoEmp.php" id="exampleModal">Lista Pedido
    ...
    <div class="breadcrumb-agile">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lista Pedido</li>
            </ol>
        </nav>
    </div>
    <?php
...
<table id="datatable" class="table table-danger">
        ...
        <td>Pendiente</td>
        <td><a type="button" href="visualizacionPedidoEmp.php?idPedido=<?php echo $lp['idPedido'];?>"><img src="../img/lupa.png" width="35" height="35"></a>
        </tr>
        <?php } ?>
        </tbody>
    </table>
