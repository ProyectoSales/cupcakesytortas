...
<!--<div id="contenido" style="border-style: solid; border-color: green; height: 500px;">-->
  <div id="contenido">
    ...
    <div id="CremasPonque">
      <img src="../img/frutas/cremaAzul.png" width="300" height="300" class=""/>
    </div>
     <div id="Chocolates">
      <img src="" width="300" height="300" class="frutas"/>
    </div>
     <div id="Masa">
      <img src="../img/ingredientes/masaNegra.png" width="500" height="500" class="">
    </div>
    <div id="Rodajas"> 
       <img src="../img/frutas/frutasTortas/duraznoCirculo.png" width="300" height="300" class=""/>
    </div>
     <div id="Figuras">
      <img src="" width="300" height="300" class="">
    </div>
    <div id="Mensajes">
      <img src="../img/frutas/mensaje1.png" width="300" height="300" class="">
    </div>
  </div>
</div>
